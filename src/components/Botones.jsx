...
export function Botones({handleIncrement, handleDecrement}){
    return(
        <div className="grid grid-cols-2 gap-2">
            <button className="text-xs bg-slate-700 focus:outline-none" onClick={()=>{handleIncrement()}}>
                <img src={suma} alt="asd"  className='w-6 h-6'/>
            </button>
            <button className="text-xs bg-slate-700 focus:outline-none" onClick={()=>{handleDecrement()}}>
